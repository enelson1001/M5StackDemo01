/****************************************************************************************
 * EnglishGreetingView.cpp - A view that displays an English Greeting
...
{
    // Class constants
    static const char* TAG = "EnglishGreetingView";

    // Constructor
    EnglishGreetingView::EnglishGreetingView()
    {
    }

    // Build the English Greeting View
    void EnglishGreetingView::build_view()
    {
        Log::info(TAG, "Building English Greeting View");

        // create screen handle
        english_greeting_screen = lv_obj_create(NULL, NULL);
        ...
        stylecont_greeting.body.main_color = LV_COLOR_RED;
        stylecont_greeting.body.grad_color = LV_COLOR_RED;
        ...
        lv_obj_t* cont_base = lv_cont_create(english_greeting_screen, NULL);
        ...
        lv_label_set_text(title_greeting, "Greetings");
        ...
        lv_label_set_text(label_greeting_lrg, "HELLO");
        ...
        lv_label_set_text(label_greeting_med, "GOOD EVENING");
        ...
        lv_obj_set_style(label_greeting_small, &style16blu);
        lv_label_set_text(label_greeting_small, "GOOD NIGHT");
        lv_obj_align(label_greeting_small, NULL, LV_ALIGN_IN_TOP_MID, 0, 180);
    }

    // Show the view
    void EnglishGreetingView::show()
    {
        lv_scr_load(english_greeting_screen);
    }
}
